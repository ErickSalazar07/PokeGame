...
void jugarTurno(Pokemon* usuario, Pokemon* enemigo)
{
    ...
    if(usuario->speed > enemigo->speed)
    {
        ...
        cout<<"El pokemon del oponente, "<<enemigo->name<<", ha recibido "<<usuario->attack<<" de danho"<<endl;
        ...
        if(enemigo->live>0)
        {
            ...
            cout<<"Tu pokemon, "<<usuario->name<<", ha recibido "<<enemigo->attack<<" de danho"<<endl;
